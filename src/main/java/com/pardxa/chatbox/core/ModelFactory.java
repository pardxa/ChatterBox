...
public class ModelFactory {
  ...
  public IUserListService createUserListServiceInstance(String className) {
    if (userListService == null
        && className.equals(BroadcastUserListService.class.getCanonicalName())) {
  ...
  public IMessageExchangeService createMessageExchangeService(String className) {
    if (messageExchangeService == null
        && className.equals(MessageExchangeService.class.getCanonicalName())) {

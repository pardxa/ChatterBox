...
public class Constants {
  ...
  public final static int CONNECTIVITY_TEST_TIME =
      Integer.parseInt(PropertyLoader.load("CONNECTIVITYTEST"));
  ...
  public final static String MESSAGE_EXCHANGE_CLASS_NAME =
      "com.pardxa.chatbox.model.MessageExchangeService";
  public final static String EMPTY_STRING = "";
  public final static String CONNECT_REFUSED = Integer.toString(1);
